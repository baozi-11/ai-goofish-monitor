const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      keywordRulesHint: 'Any matching keyword can alert. Leave max price blank to alert without a price limit.',
      keywordRulesPlaceholder: 'Keyword',
      keywordRuleKeyword: 'Keyword',
      keywordRuleMaxPrice: 'Max alert price',
      addKeywordRule: 'Add keyword',
      removeKeywordRule: 'Remove keyword',
